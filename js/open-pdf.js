...
* This is the plugin
*/
(function(a){a.createModal=function(b){defaults={title:"",message:"Echo",closeButton:true,scrollable:false};var b=a.extend({},defaults,b);var c=(b.scrollable===true)?'style=""':"";
html='<div class="modal fade" id="myModal">';
html+='<div class="modal-dialog" style="width: 90%;; max-width: none">';
...
$(function(){
    $('.view-pdf').on('click',function(){
        ...
        $.createModal({
            ...
            closeButton:false,
            scrollable:false,
            title: '<a href="'+pdf_link+'" style="color: #4c585d;font-size: medium;padding: 16px 16px 16px 16px;" download>Télécharger le document</a>'
        });
        return false;
    });
})
...
$(function(){
    $('.view-site').on('click',function(){
        ...
        $.createModal({
            ...
            closeButton:false,
            scrollable:false,
            title: '<a href="'+pdf_link+'" style="color: #4c585d;font-size: medium;padding: 16px 16px 16px 16px;" target="_blank">Voir sur le site</a>'
        });
        return false;
    });
})
