...
$(function(){
    $('.view-video').on('click',function(){
        ...
        var iframe = '<iframe width="100%" height="415" src="'+pdf_link+'" frameborder="0" allowfullscreen></iframe>'
        $.createModalVid({
            message: iframe,
            closeButton:false,
            scrollable:false
