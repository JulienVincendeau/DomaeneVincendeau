    ...
    <p style="position: fixed;bottom:6%;left:1%;">
      ...
      <div class="container  col-md-10  col-xs-10 col-sm-10 sectionFooter">
        ...
        <div class="row  col-xs-12 col-sm-7 col-md-7" >
          ...
          <row class="row  col-md-9  col-xs-12 col-sm-12" >
            <div>

              <p class="fulljustify" style="color:white;">	Dom&auml;ne Vincendeau <b style="font-weight: bolder;">&nbsp;fon &bull; fax <a href="tel:+33241572115" style="text-decoration: none; color: inherit;" >02 41 57 21 15</a>&nbsp;</b> <a href="mailto:contact@domaenevincendeau.com" style="text-decoration: none; color: inherit;" >contact@domaenevincendeau.com</a></p>
